...
urlpatterns = [
    ...
    url(r'^perfil/(?P<id>\d+)/invite$', views.convite_perfil, name="convite_perfil"),
    ...
    url(r'^perfil/(?P<perfil_id>\d+)/superusuario$', views.mudar_superusuario, name="mudar_superusuario"),
    ...
    #url(r'^perfil/(?P<convite_id>\d+)/convites$', views.view_convite, name="convites"),
